      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative flex justify-center">
          <input
            ...
            className="w-full h-8 p-3 pt-6 placeholder-transparent text-black bg-transparent border border-secBlue rounded-md peer focus:outline-none focus:shadow-sm md:w-64"
            placeholder="verify"
            autoComplete="off"
          />
          <label
