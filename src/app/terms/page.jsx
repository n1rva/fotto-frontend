    ...
    <main className="min-h-[80vh] space-y-10 p-3 mx-auto container max-w-lg flex flex-col mt-12 bg-[#F9FEFF]/75 rounded-lg md:max-w-2xl lg:max-w-5xl xl:max-w-7xl">
      ...
      <div>
        <p className="lg:text-lg">
          ...
          <a className="hover:opacity-80" href="https://fizyottolive.com">
            fizyottolive.com
          </a>{" "}
          web sitemizi ziyaret etmeden önce işbu kullanım koşulları sözleşmesini
        ...
        <p className="lg:text-lg">
          ...
          web sitesi Fizyotto tarafından yönetilmekte olup, bundan sonra SİTE
          ...
          olarak SİTE'ye aittir ve SİTE üzerinden güncel olarak paylaşılacak
          olan bu değişiklikleri, tüm kullanıcılarımız baştan kabul etmiş
          sayılır.
        </p>
      </div>
      <div>
        <h2 className="text-lg font-medium">Gizlilik</h2>
        <p className="lg:text-lg">
      ...
      <div>
        <h2 className="text-lg font-medium">Hizmet Kapsamı</h2>
        <p className="lg:text-lg">
          Fizyotto olarak, sunacağımız hizmetlerin kapsamını ve niteliğini,
      ...
      <div>
        <h2 className="text-lg font-medium">Telif Hakları</h2>
        <p className="lg:text-lg">
          ...
          "içerik" olarak anılacaktır) Fizyotto olup, tüm hakları saklıdır.
          Yazılı izin olmaksızın site içeriğinin çoğaltılması veya kopyalanması
          kesinlikle yasaktır.
        </p>
      </div>
      <div>
        <h2 className="text-lg font-medium">Genel Hükümler</h2>
        <p className="lg:text-lg">
      ...
      <div>
        <h2 className="text-lg font-medium">Sorumluluğun Sınırlandırılması</h2>
        <p className="lg:text-lg">
      ...
      <div>
        <h2 className="text-lg font-medium">Uyuşmazlık Çözümü</h2>
        <p className="lg:text-lg">
          İşbu Sözleşme'nin uygulanmasından veya yorumlanmasından doğacak her
          türlü uyuşmazlığın çözümünde, Türkiye Cumhuriyeti yasaları uygulanır;
          Tokat Adliyesi Mahkemeleri ve İcra Daireleri yetkilidir.
        </p>
      </div>
    </main>
  );
