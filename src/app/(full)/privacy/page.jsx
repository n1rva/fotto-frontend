export const metadata = {
  title: "Gizlilik Politikası | Fizyotto Live",
};
    ...
    <main className="min-h-screen my-12">
      <div className="bg-[#F3FDFF] min-h-[18rem] flex flex-col md:flex-row">
        <div className="max-w-sm mx-auto space-y-1 my-3 md:space-y-4 md:max-w-md md:py-4 lg:max-w-4xl lg:py-8 lg:px-3 lg:space-y-5">
          ...
          <div className="space-y-8 my-10 lg:my-14">
            <div className="">
              <h2 className="text-lg font-medium">
                Güvenliğiniz Bizim İçin Önemli
              </h2>
              <p className="lg:text-lg">
                Biz, Fizyotto, veri sorumlusu olarak, bu gizlilik ve kişisel
            ...
            <div>
              ...
              <p className="lg:text-lg">
                ...
                <br />- Kişisel verilerin kanuna aykırı olarak işlenmesi
            ...
            <div>
              ...
              <p className="lg:text-lg">
                Sizlere hizmet sunabilmek amacıyla analizler yapabilmek için,
                ...
                <a
                  ...
                  href="mailto:fizyottolive@gmail.com"
                >
