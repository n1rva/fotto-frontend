export const metadata = {
  title: "Çerez Politikası | Fizyotto Live",
};
...
function Cookies() {
  return (
    <main className="min-h-[80vh] space-y-10 p-3 mx-auto container max-w-lg flex flex-col mt-12 bg-[#F9FEFF]/75 rounded-lg md:max-w-2xl lg:max-w-5xl xl:max-w-7xl">
      <div>
        <h1 className="font-medium text-xl lg:text-2xl">Çerez Politikası</h1>
        <p className="lg:text-lg">Son güncellenme: 03/08/2023</p>
      </div>
      <div>
        <p className="lg:text-lg">
          Biz, Fizyotto, olarak güvenliğinize önem veriyor ve bu Çerez
      ...
      <div>
        <h2 className="text-lg font-medium">Çerez Nedir?</h2>
        <p className="lg:text-lg">
      ...
      <div>
        <h2 className="text-lg font-medium">1. Zorunlu Çerezler</h2>
        <p className="lg:text-lg">
      ...
      <div>
        <h2 className="text-lg font-medium">2. Performans Çerezleri</h2>
        <p className="lg:text-lg">
      ...
      <div>
        <h2 className="text-lg font-medium">3. Fonksiyonel Çerezler</h2>
        <p className="lg:text-lg">
      ...
      <div>
        <h2 className="text-lg font-medium">4. Reklam Çerezleri</h2>
        <p className="lg:text-lg">
      ...
      <div>
        <h2 className="text-lg font-medium">Çerezler Nasıl Yönetilmektedir?</h2>
        <p className="lg:text-lg">
          ...
          email@site.com e-mail adresi üzerinden iletişime geçebilirsiniz.
        </p>
      </div>
    </main>
  );
