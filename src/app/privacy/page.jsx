function Privacy() {
  return (
    <main className="min-h-[80vh] space-y-10 p-3 mx-auto container max-w-lg flex flex-col mt-12 bg-[#F9FEFF]/75 rounded-lg md:max-w-2xl lg:max-w-5xl xl:max-w-7xl">
      <div>
        <h1 className="font-medium text-xl lg:text-2xl">Gizlilik Politikası</h1>
        <p className="lg:text-lg">Son güncellenme: 20/07/2023</p>
      </div>
      <div className="">
        <h2 className="text-lg font-medium">Güvenliğiniz Bizim İçin Önemli</h2>
        <p className="lg:text-lg">
          Biz, Fizyotto, veri sorumlusu olarak, bu gizlilik ve kişisel verilerin
      ...
      <div>
        ...
        <p className="lg:text-lg">
          ...
          <br />- Kişisel verilerin kanuna aykırı olarak işlenmesi sebebiyle
          zarara uğraması hâlinde zararın giderilmesini talep etme, haklarına
          sahiptir.
        </p>
      </div>
      <div>
        <h2 className="text-lg font-medium">İletişim</h2>
        <p className="lg:text-lg">
          Sizlere hizmet sunabilmek amacıyla analizler yapabilmek için, sadece
          ...
          <a className="hover:opacity-80" href="mailto:fizyottolive@gmail.com">
